...
public class UFilePutTest {
	public static void main(String args[]) {
		String bucketName = "xiongben";
		String key = "hello.jpg";
		String filePath = "/Users/wangdong/Pictures/InternetPicture/hello.jpg";
		String saveAsPath = "/Users/wangdong/Pictures/";
		String configPath = "http://xiongben.ufile.ucloud.com.cn/hello.jpg";
		
		//加载配置项
		//UFileConfig.getInstance().loadConfig(configPath);
		
		//或者逐个设置配置项
		UFileConfig.getInstance().setUcloudPublicKey("SuQ26Zpuejf9UZuFBIkIFV6a9C6809KAMP/dAUtrGWnFRQT5JsLqjA==");
		UFileConfig.getInstance().setUcloudPrivateKey("221f19c4134a219e54b45e9b5ee278495bc8c43f");
		UFileConfig.getInstance().setProxySuffix(".ufile.ucloud.com.cn");
